const GameManagementServices = require('../../admin/game_management/services/game_management_services')
...
class BettingHistoryUtils {
    ...
    async getCleanBettingData(bettingdataList) {
        ...
        if (!gameData.hasSpecialTime) {
            ...
            if (!this.isCurrentTimeBeforeTime(gameData.closingTime)) {
                return []
            }
            ...
            if (!todaygameSchedule.isOpen) {
                ...
                // if close bid time is overed
                if (!this.isCurrentTimeBeforeTime(todaygameSchedule.closingTime)) {

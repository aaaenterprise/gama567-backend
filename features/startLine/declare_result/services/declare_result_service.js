...
class DeclareResultService {
    ...
    async createResult(queryData) {
        try {
            ...
            if (declare_result_model && declare_result_model.openPana ) {
            ...
            if (!declare_result_model) {
                ...
                const { timestamp, gameName,  pana, ank } = queryData;
    ...
    async deleteDeclaredResultById(id, ) {
        ...
        try {
            ...
            if (result.openPana == '' ) {
                throw new Error("result already deleted")
